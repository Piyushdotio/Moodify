...
const Register = () => {
  ...
  async function handleSubmit(e) {
      ...
      try {
          ...
          const errMsg = err.response?.data?.message || err.message || "Registration failed. Please check your inputs.";
          setError(errMsg);
      }
  }
    ...
    <main className="Register-page">
      <div className="auth-card">
        <div className="auth-card__header">
          ...
          <p className="auth-card__subtitle">Join Moodify to stream music matching your expressions</p>
        </div>
        ...
        <p className="auth-card__footer">
          Already have an account? <Link to="/login" className="auth-card__link">Login here</Link>
        </p>
      </div>
    </main>
  );
